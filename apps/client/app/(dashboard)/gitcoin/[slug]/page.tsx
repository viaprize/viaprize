...
export default function CreateGitcoin() {
  return (
    <div className="my-10 px-3 sm:px-6 md:px-14 lg:px-20">
      <ImageTitleCard
        title={
          'SOLARPUNK GUILD, gamifying hypercerts for Guild Members impact assessment '
        }
        name={'by 0xEB7...7B9D0'}
        img={
          'https://d16c97c2np8a2o.cloudfront.net/ipfs/bafkreigf6g54vvjcbqogij5dri5iauvqbmhbpsgoasvm5scapjpp56k6ji?img-height=640'
        }
      />
