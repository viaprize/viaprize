...
export class First1696139792816 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_ad5065ee18a722baaa932d1c3c" ON "user" ("authId") `);
        ...
        await queryRunner.query(`CREATE TABLE "pact" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(255) NOT NULL, "terms" text NOT NULL, "address" character varying(42) NOT NULL, "transactionHash" character varying(66) NOT NULL, "blockHash" character varying(66), CONSTRAINT "PK_d0ec8de1adc545b4f849e616f9b" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "prize_proposals" ADD CONSTRAINT "FK_5e59db131371ae557edfc20abad" FOREIGN KEY ("user") REFERENCES "user"("authId") ON DELETE NO ACTION ON UPDATE NO ACTION`);
