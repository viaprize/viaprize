...
export class JobService {
  ...
  async registerJobForEndKickStarterCampaign(
    contractAddress: string,
    schedule: JobSchedule,
  ) {
    const anonKey = this.configService.getOrThrow<AllConfigType>(
    ...
    await this.registerJob(
      'https://uofqdqrrquswprylyzby.supabase.co/functions/v1/trigger-deadline',
      contractAddress,
      schedule,
      headers,
      body,
