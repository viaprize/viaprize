...
export const PrizeCreationTemplate = {
  type: 'doc',
  content: [
    {
      type: 'paragraph',
    ...
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: 'This prize initiative is driven by our dedication to innovation and addressing pressing challenges. We recognize the power of collective efforts and are committed to supporting endeavors that drive meaningful impact.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: 'Our primary objective is to catalyze positive change in various domains through collaborative efforts.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: 'To participate in this prize category, ensure compliance with the following:',
        },
      ],
    },
    {
          ...
          content: [
            {
              ...
              content: [
                {
                  type: 'text',
                  text: "Develop an innovative solution that aligns with the prize's theme.",
                },
              ],
            },
          ],
    ...
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: 'Participants are required to provide evidence of their contributions:',
        },
      ],
    },
    {
          ...
          content: [
            {
              ...
              content: [
                {
                  type: 'text',
                  text: 'Share a link to the project website and the open-source code repository (if applicable).',
                },
              ],
            },
          ],
      ...
      content: [
        {
          ...
          text: 'Judging Criteria (for hackathons)',
        },
      ],
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: 'Projects will be evaluated based on the following criteria:',
        },
      ],
    },
    {
              ...
              content: [
                {
                  ...
                  text: 'User Experience and Design (1-10 points):',
                },
                {
                  type: 'text',
                  text: ' Assess the visual appeal and usability of the project, including UI/UX design.',
                },
              ],
            },
          ],
              ...
              content: [
                {
                  ...
                  text: 'Creativity (1-10 points):',
                },
                {
                  type: 'text',
                  text: ' Evaluate the uniqueness and innovation of the project compared to existing solutions.',
                },
              ],
            },
          ],
              ...
              content: [
                {
                  ...
                  text: 'Presentation and Pitch (1-10 points):',
                },
                {
                  type: 'text',
                  text: " Consider the clarity, conciseness, and engagement level of the team's presentation and pitch.",
                },
              ],
            },
          ],
    ...
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: 'We are excited to see the transformative projects that emerge from this prize initiative. Your contributions have the potential to drive positive change, and we look forward to celebrating your achievements. Good luck!',
        },
      ],
    },
  ],
