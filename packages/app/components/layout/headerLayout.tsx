...
function ProfileMenu() {
  ...
  return (
    ...
    <Group position="center">
      <Menu withArrow trigger="hover" openDelay={100} closeDelay={400}>
        ...
        <Menu.Dropdown p="md" mr="sm">
         ...
         <Menu.Item onClick={()=>setSwitchWallet(true)}icon={<IconArrowsLeftRight size={14} />}>Switch Wallet</Menu.Item>
          {authenticated ? (
    ...
    <Modal size='lg' opened={switchWallet} onClose={()=>setSwitchWallet(false)} title="Switch Wallets">
<SwitchAccount/>
    </Modal>
