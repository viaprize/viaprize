...
export class Server extends BaseServiceV2<Options, Metrics, State> {
  constructor(options?: any) {
    super({
      ...
      options: {
        loopIntervalMs: 2000,
        dbPath: "main.db",
        pactFactoryAddress: "0x642a7864cBe44ED24D408Cbc38117Cfd6E6D1a95",
        rpcProvider:
  ...
  async init(): Promise<void> {
    ...
    this.logger.info(
      `Pact factory address: ${this.options.pactFactoryAddress}`
    );
  ...
  async main(): Promise<void> {
    ...
    // look at remotme chain to see if more blocks have been made
